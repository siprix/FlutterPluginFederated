...
- Updated recorder implementation
  ...
  = Set bitrate 128kbps
- Fixed 'Call_UpgradeToVideo' (start video capturer when upgrade accepted/requested by remote side)
- Added new setting `iniData.use16kHzAudio` (forces using 16kHz sample rate for audio)
- Added ability to report current audio device
  //2026.06.20
...
- Added new option 'triggerOnIncomingCallByNotifOnly'. Trigger 'onIncomingCall' event only when user taps notification
  //2026.05.29
